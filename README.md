...
A collection of Development Policy Areas collected from Local Authorities.

The national dataset is in a format consistent with other Digital Land datasets as defined by the [development-policy-area schema](https://digital-land.github.io/specification/schema/development-policy-area/).
